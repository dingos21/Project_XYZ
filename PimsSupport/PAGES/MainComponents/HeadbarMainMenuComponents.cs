...
{
    public class HeadbarMainMenuComponents : BaseComponent
    {
        ...
        public HeadbarMainMenuComponents(IWebDriver driver) : base(driver)
        {
            InitializeElements();
        }
        ...
        private void InitializeElements()
        {
            ...
            // Bond ddm
            Relationships = new WebElementProxy(driver, By.CssSelector("li:nth-of-type(1) > ul[role='menu']  a"));
            // CAPS ddm
            ...
            Relationships2 = new WebElementProxy(driver, By.CssSelector("li:nth-of-type(5) > ul[role='menu'] > li:nth-of-type(12) > a"));
        ...
        public bool ValidateUserNameAppeared(string userName) { return helloUser.GetText().ToString().ToLower().Equals(userName.ToLower()); }
        public bool ValidateRelationshipsEnabled() { return Relationships.IsPresent() && Relationships.IsInteractable(); }
        ...
        public bool ValidateRelationships2Enabled() { return Relationships2.IsPresent() && Relationships2.IsInteractable(); }
